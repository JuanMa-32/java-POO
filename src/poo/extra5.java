...
de tipo  debe pedir alString, y hazla igual a un elemento del array (por ejemplo, mesSecreto = mes[9]. El
programa usuario que adivine el mes secreto. Si el usuario acierta mostrar
...
¡Ha acertado!
    ...
    public static void main(String[] args) {
        ...
        DescubrirMes d1 = new DescubrirMes();
